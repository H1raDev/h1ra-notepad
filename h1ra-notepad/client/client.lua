...
RegisterNetEvent("h1ra-notepad:Client:Destroy", function(data)
	loadAnimDict("pickup_object")
	TaskPlayAnim(PlayerPedId(), "pickup_object", "pickup_low", 8.0, -8.0, -1, 0, 0, false, false, false)
	unloadAnimDict("pickup_object")
	Wait(900)
	TriggerServerEvent("h1ra-notepad:Server:Sync", data.coords)
	TriggerServerEvent("h1ra-notepad:Server:Destroy", data.id)
end)

RegisterNetEvent("h1ra-notepad:Client:Sync", function(coords)
